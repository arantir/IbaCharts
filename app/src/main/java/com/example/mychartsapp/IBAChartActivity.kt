...
import com.example.mychartsapp.IBAChart.MPAndroidChartManager
import com.example.mychartsapp.utils.IBAParser
import com.example.mychartsapp.models.PDAFile
        ...
        if (result.resultCode == RESULT_OK) {
            result.data?.data?.let { uri ->
                ...
                if (fileName != null && fileName.endsWith(".dat", ignoreCase = true)) {
                    ...
                    // Копируем в буфер обмена для отладки
